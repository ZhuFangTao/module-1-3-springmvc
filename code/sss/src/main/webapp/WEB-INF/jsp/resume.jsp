...
<head>
    ...
    <title>简历界面</title>
    <link href="../css/2.4c6ee7a4.chunk.css" rel="stylesheet">
...
<script>!function (e) {
    ...
    var a = this["webpackJsonplagou-resume"] = this["webpackJsonplagou-resume"] || [], f = a.push.bind(a);
    a.push = r, a = a.slice();
    for (var i = 0; i < a.length; i++) r(a[i]);
    var p = f;
    t()
}([])</script>
<script src="../js/2.44bec3c0.chunk.js"></script>
<script src="../js/main.e4524648.chunk.js"></script>
</body>
</html>